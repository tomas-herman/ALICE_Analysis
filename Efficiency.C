...
void ComputeEfficiency(Double_t y_min, Double_t y_max, TString ADveto, TString trigger)
{
  ...
  LoadData("/mnt/data/Data_processing/Processed_data/TrainResults/579_20200702-1048-LHC18l7/CohJpsiToMu_AnalysisResults.root", "MCRec", "NanoMUONCMUP6", dataIN18l7_Rec_CohJpsiToMu);
  LoadData("/mnt/data/Data_processing/Processed_data/TrainResults/579_20200702-1048-LHC18l7/CohPsi2sToMu_AnalysisResults.root", "MCRec", "NanoMUONCMUP6", dataIN18l7_Rec_CohPsi2sToMu);
  LoadData("/mnt/data/Data_processing/Processed_data/TrainResults/579_20200702-1048-LHC18l7/CohPsi2sToMuPi_AnalysisResults.root", "MCRec", "NanoMUONCMUP6", dataIN18l7_Rec_CohPsi2sToMuPi);
  ...
  LoadData("/mnt/data/Data_processing/Processed_data/TrainResults/579_20200702-1048-LHC18l7/CohJpsiToMu_AnalysisResults.root", "Gen", "NanoMUONCMUP6", dataIN18l7_Gen_CohJpsiToMu);
  LoadData("/mnt/data/Data_processing/Processed_data/TrainResults/579_20200702-1048-LHC18l7/CohPsi2sToMu_AnalysisResults.root", "Gen", "NanoMUONCMUP6", dataIN18l7_Gen_CohPsi2sToMu);
  LoadData("/mnt/data/Data_processing/Processed_data/TrainResults/579_20200702-1048-LHC18l7/CohPsi2sToMuPi_AnalysisResults.root", "Gen", "NanoMUONCMUP6", dataIN18l7_Gen_CohPsi2sToMuPi);
  ...
  if (trigger.Contains("CMUP11")){
    LoadData("/mnt/data/Data_processing/Processed_data/TrainResults/578_20200702-1049-LHC16b2/CohJpsiToMu_AnalysisResults.root", "MCRec", "NanoMUONScalingOn", dataIN16b2_Rec_CohJpsiToMu);
    LoadData("/mnt/data/Data_processing/Processed_data/TrainResults/578_20200702-1049-LHC16b2/CohPsi2sToMu_AnalysisResults.root", "MCRec", "NanoMUONScalingOn", dataIN16b2_Rec_CohPsi2sToMu);
    LoadData("/mnt/data/Data_processing/Processed_data/TrainResults/578_20200702-1049-LHC16b2/CohPsi2sToMuPi_AnalysisResults.root", "MCRec", "NanoMUONScalingOn", dataIN16b2_Rec_CohPsi2sToMuPi);
  }
  ...
  if (trigger.Contains("CMUP11")){
    LoadData("/mnt/data/Data_processing/Processed_data/TrainResults/578_20200702-1049-LHC16b2/CohJpsiToMu_AnalysisResults.root", "Gen", "NanoMUONScalingOn", dataIN16b2_Gen_CohJpsiToMu);
    LoadData("/mnt/data/Data_processing/Processed_data/TrainResults/578_20200702-1049-LHC16b2/CohPsi2sToMu_AnalysisResults.root", "Gen", "NanoMUONScalingOn", dataIN16b2_Gen_CohPsi2sToMu);
    LoadData("/mnt/data/Data_processing/Processed_data/TrainResults/578_20200702-1049-LHC16b2/CohPsi2sToMuPi_AnalysisResults.root", "Gen", "NanoMUONScalingOn", dataIN16b2_Gen_CohPsi2sToMuPi);
  }
  ...
  // cout << "Rec: " << N_Rec_CohJpsiToMu_PtCut << endl;
  // cout << "Gen: " << N_Gen_CohJpsiToMu << endl;
  // gROOT->ProcessLine(".q");
  ...
  cout<< "##########################################################################" << endl;
  cout << "Efficiency computed for " << trigger << ", " << ADveto << ", " << y_min << " < y < " << y_max << endl;
  cout<< "##########################################################################" << endl;
